...
class TestListAgentSOPs:
    ...
    def test_list_agent_sops_returns_sorted_list(self, registered_tools):
        """Test that list_agent_sops returns sorted SOPs with name and description"""
    ...
    def test_list_agent_sops_returns_correct_descriptions(self, registered_tools):
        ...
        assert result[0]["description"] == "First test SOP"
        assert result[1]["description"] == "Second test SOP"
...
class TestGetAgentSOP:
    ...
    def test_get_agent_sop_returns_full_content(self, registered_tools, test_sops):
        ...
        expected_content = test_sops[1]["content"]  # test-sop-a is second in list
