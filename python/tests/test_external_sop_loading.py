...
"""
            ...
            assert mock_mcp_instance.prompt.call_count >= 1  # At least external SOP registered
...
"""
            ...
            prompt_calls = [call for call in mock_mcp_instance.prompt.call_args_list 
...
"""
    ...
    def test_mcp_server_without_external_sops(self, mock_fastmcp):
        ...
        assert mock_mcp_instance.prompt.call_count >= 4  # Built-in SOPs (code-assist, etc.)
