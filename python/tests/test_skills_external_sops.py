...
class TestSkillsCLIIntegration:
    ...
    def test_skills_accepts_sop_paths_argument(self):
        ...
        with patch('strands_agents_sops.__main__.generate_anthropic_skills') as mock_generate:
            with patch('sys.argv', ['strands-agents-sops', 'skills', '--sop-paths', '~/test-sops']):
    ...
    def test_skills_accepts_both_arguments(self):
        ...
        with patch('strands_agents_sops.__main__.generate_anthropic_skills') as mock_generate:
            with patch('sys.argv', ['strands-agents-sops', 'skills', '--sop-paths', '~/sops', '--output-dir', './output']):
                from strands_agents_sops.__main__ import main
                main()
    ...
    def test_skills_backward_compatibility(self):
        ...
        with patch('strands_agents_sops.__main__.generate_anthropic_skills') as mock_generate:
            with patch('sys.argv', ['strands-agents-sops', 'skills', '--output-dir', './skills']):
                from strands_agents_sops.__main__ import main
                main()
...
"""
            ...
            with tempfile.TemporaryDirectory() as output_dir:
                ...
                assert "This is an external test SOP for skills generation." in skill_content
...
"""
            ...
            with tempfile.TemporaryDirectory() as output_dir:
                generate_anthropic_skills(output_dir, sop_paths=f"{temp_dir1}:{temp_dir2}")
