...
def generate_anthropic_skills(output_dir: str, sop_paths: Optional[str] = None):
    ...
    if sop_paths:
        ...
        for sop in external_sops:
            if sop['name'] not in processed_sops:
                ...
                _create_skill_file(output_path, sop['name'], sop['content'], sop['description'])
...
def _create_skill_file(output_path: Path, skill_name: str, content: str, description: str):
